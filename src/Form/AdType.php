...
class AdType extends ApplicationType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('introduction', TextType::class, $this->getConfiguration('Itroduction',"Donnez une description globale de l'annonce"))
            ->add('content', TextareaType::class, $this->getConfiguration('Decription détaillée','Tapez une description qui donne vraiment envie de venir chez vos!'))
